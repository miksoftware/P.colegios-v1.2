<div>
    ...
    <button @click="$dispatch('logout-started'); $wire.logout()" class="w-full mt-2 flex items-center justify-center gap-2 px-4 py-2 text-sm font-medium text-red-600 hover:bg-red-50 rounded-xl transition-all">
