...
document.addEventListener('DOMContentLoaded', function() {
    ...
    window.exportPaymentExcel = function() {
        ...
        ws['!cols']=[{wch:10},{wch:12},{wch:18},{wch:12},{wch:35},{wch:15},{wch:25},{wch:25},{wch:25},{wch:40},{wch:50},{wch:12},{wch:20},{wch:8},{wch:8},{wch:18},{wch:14},{wch:18},{wch:20},{wch:15},{wch:15},{wch:15},{wch:15},{wch:18},{wch:30}];
        var cc=[15,16,17,19,20,21,22,23];
