...
<head>
    <meta charset="UTF-8">
    <title>Acta de Finalización - Contrato {{ $contract->formatted_number }}</title>
    <style>
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        .doc-title { font-size: 11px; font-weight: bold; text-transform: uppercase; color: #1e3a5f; margin-top: 10px; letter-spacing: 1px; }

        .info-table { width: 100%; border-collapse: collapse; }
        .info-table td { padding: 3px 15px; font-size: 10px; vertical-align: top; border-bottom: 1px solid #ddd; }
        .info-label { font-weight: bold; color: #1e3a5f; width: 190px; text-transform: uppercase; font-size: 9px; }

        .text-block { padding: 8px 15px; font-size: 10px; text-align: justify; }
        .bold { font-weight: bold; }

        .section-title { background: #1e3a5f; color: #fff; padding: 4px 15px; font-size: 9px; font-weight: bold; text-transform: uppercase; letter-spacing: 0.5px; }
...
<div class="container">
    <div class="doc-border">
        ...
        <div class="header">
            ...
            <div class="doc-title">Acta de Finalización y Liquidación del Contrato No. {{ $contract->formatted_number }}</div>
        </div>
        ...
        <table class="info-table">
            ...
            <tr><td class="info-label">Valor Adicional:</td><td>${{ number_format($valorAdicional, 2, ',', '.') }}</td></tr>
            ...
            <tr><td class="info-label">Fecha de Terminación:</td><td>{{ $contract->end_date?->translatedFormat('d \\d\\e F \\d\\e Y') ?? '' }}</td></tr>
            <tr><td class="info-label">Registro Presupuestal:</td><td>{{ $rpNumbers ?: 'N/A' }}</td></tr>
        </table>
        ...
        <table class="info-table">
            ...
            <tr><td class="info-label">Valor Pago Parcial:</td><td>${{ number_format($totalPaid, 2, ',', '.') }}</td></tr>
