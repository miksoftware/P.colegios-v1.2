...
<div class="container">
    <div class="doc-border">
        ...
        <div class="title-box">
            ...
            <div class="title-sub">{{ mb_strtoupper($convocatoria->modality_name ?? 'SEGÚN LEY 715 DEC 1075 DE 2015') }}</div>
        ...
        <div class="info-row" style="border-top: 1px solid #ddd; padding-top: 8px;">
            <span class="info-label">MODALIDAD:</span> {{ mb_strtoupper($convocatoria->modality_name ?? 'SEGÚN LEY 715 DEC 1075 DE 2015') }}
        </div>
        ...
        <div style="border-top: 1px solid #ddd; padding: 8px 15px;">
            <table class="presupuesto-table">
                <tr>
                    ...
                    <td>
                        La documentación relacionada con el presente <span class="bold">{{ mb_strtoupper($convocatoria->modality_name ?? 'SEGÚN LEY 715 DEC 1075 DE 2015') }}</span>
