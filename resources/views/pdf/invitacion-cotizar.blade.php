...
<div class="container">
    <div class="doc-border">
        ...
        <div class="header">
            ...
            <div class="doc-title">Invitación a Cotizar y/o a Presentar Propuesta N. {{ $convocatoria->formatted_number }}</div>
        </div>
        ...
        <div class="text-block">
            En cumplimiento a lo establecido en el CAPÍTULO 2, Numeral 1 del Manual de contratación institucional aprobado mediante acuerdo No. 03 de fecha 06 de March de 2024 por el Consejo Directivo, en la cual se establecen los parámetros para garantizar la selección objetiva del proveedor, se publica la presente convocatoria para la comparación de cotizaciones.
        </div>
        <div class="text-block">
            Podrán participar en el presente proceso de selección todas las personas naturales o jurídicas, legalmente constituidas en Colombia, nacionales o extranjeras, las uniones temporales o consorcios, que cumplan con los requisitos exigidos en la presente invitación pública y que no se encuentren incursas en causales de inhabilidad o incompatibilidad.
        </div>
        ...
        <div class="conv-box">
            ...
            <div class="conv-box-row">
                ...
                <div class="conv-box-value">{{ $convocatoria->start_date?->translatedFormat('d \\d\\e F \\d\\e Y') ?? '' }}</div>
            </div>
        </div>

        {{-- ===== DOCUMENTOS SOLICITADOS ===== --}}
        <div style="padding: 4px 12px;">
            <p class="bold" style="font-size: 8px; margin-bottom: 4px;">Documentos solicitados para la presentación de las cotizaciones:</p>
        ...
        <div class="text-block">
            ...
            o entregados directamente en la oficina de secretaría de la institución educativa
            {{ $school->address ?? '' }}, {{ $school->municipality ?? '' }}.
            <br><br>
            SERÁ LA FECHA PREVISTA COMO LÍMITE PARA LA RECEPCIÓN DE LAS MISMAS. Las cotizaciones que no se encuentren dentro de la respectiva hora y fecha fijadas serán consideradas como extemporáneas y NO SERÁN TENIDAS EN CUENTA.
            <br><br>
        ...
        <div style="padding: 4px 12px;">
            <table class="plazo-table">
                <thead>
                    <tr>
                        <th colspan="4" style="text-align: left;">Plazo Límite para la Presentación de la Propuesta</th>
                    </tr>
                </thead>
                <tbody>
                    <tr>
                        <td class="bold" style="width: 10%;">DÍA:</td>
                        <td style="width: 40%;">{{ $convocatoria->start_date?->format('d/m/Y') ?? '' }}</td>
                        <td class="bold" style="width: 10%;">HORA:</td>
                        <td style="width: 40%;">3:00:00 PM</td>
                    </tr>
                </tbody>
            </table>
            <table class="plazo-table" style="margin-top: 2px;">
                <tbody>
                    ...
                    <tr>
                        ...
                        <td style="width: 40%;">{{ $convocatoria->start_date?->format('d/m/Y') ?? '' }}</td>
                        <td class="bold" style="width: 10%;">HORA:</td>
                        <td style="width: 40%;">3:30:00 PM</td>
                    </tr>
                </tbody>
            </table>
            <table class="plazo-table" style="margin-top: 2px;">
                <tbody>
                    <tr>
                        <td colspan="4" class="bold" style="text-align: center;">Fecha de Firma de Orden u Contrato</td>
                    </tr>
                    <tr>
                        <td class="bold" style="width: 10%;">DÍA:</td>
                        <td colspan="3">{{ $convocatoria->end_date?->format('d/m/Y') ?? '' }}</td>
                    </tr>
                </tbody>
            </table>
        </div>
        ...
        <div class="text-block">UN PAGO</div>

        {{-- ===== DESCUENTOS APLICABLES ===== --}}
        <div class="section-title">Descuentos Aplicables</div>
        <div class="text-block">
            <span class="bold">1. DESCUENTOS POR RETENCIÓN EN LA FUENTE:</span> La Institución Educativa realizará los descuentos de Ley por concepto de retención en la fuente por servicios, compra u honorarios según corresponda y siempre y cuando se cumpla la base para realizar el descuento y de Retención de IVA, si es el caso.
            <br><br>
            <span class="bold">2. DESCUENTOS POR ESTAMPILLAS DEPARTAMENTALES:</span> Para la cancelación de la compra o servicio descrito en el presente documento, el Proveedor deberá presentar el recibo de pago de estampillas que se liquidará en la Caja del Ente Total siempre y cuando se cumpla la base para su liquidación.
            <br><br>
            <span class="bold">3. DESCUENTOS POR ESTAMPILLAS MUNICIPALES:</span> La Institución Educativa descontará las estampillas municipales en caso de que aplique, cumpliendo con las bases para su liquidación.
        </div>

        {{-- ===== CONVOCATORIA A VEEDURÍAS ===== --}}
        <div class="section-title">Convocatoria a Veedurías Ciudadanas</div>
        <div class="text-block">
            En cumplimiento al artículo 66 de la Ley 80 de 1993 y la Ley 850 de 2003, convoca a todos los comités u organizaciones de veedurías ciudadanas que se encuentren legalmente establecidas en este municipio, con el fin de que participen del control social a los procesos.
            <br><br>
            La documentación relacionada de la presente Selección Objetiva puede ser consultada en la Secretaría de la Institución Educativa ubicada en {{ $school->address ?? '' }}, {{ $school->municipality ?? '' }}, a partir los 3 días hábiles posterior a la publicación de la convocatoria.
            @if($school->email)
        ...
        <div class="text-block">
            Los estudios y documentos previos que hacen parte del presente proceso de selección podrán ser consultados en la oficina de secretaría de la Institución Educativa ubicada en {{ $school->address ?? '' }}, {{ $school->municipality ?? '' }}.
        </div>

        {{-- ===== DECLARATORIA DE DESIERTA ===== --}}
        <div class="section-title">Declaratoria de Desierta</div>
        <div class="text-block">
            a) Cuando ninguno de las personas naturales o jurídicas postulados cumplan con el lleno de los requisitos exigidos en la convocatoria.
            <br>
        ...
        <div class="text-block">
            <table class="criterio-table">
                ...
                <tbody>
                    <tr>
                        <td colspan="2" style="text-align: right; font-weight: bold;">100</td>
                    </tr>
                </tbody>
            </table>
            <p style="margin-top: 6px;">
                Para la escogencia de la oferta se hará un análisis comparativo y evaluativo de las propuestas, teniendo en cuenta el criterio de la propuesta más económica que satisfaga las necesidades requeridas por la Institución Educativa.
            </p>
            <p style="margin-top: 4px;">
                Para ello se garantiza: La calificación de cada una de las propuestas se hará sobre un máximo de 100 puntos. PRIMER CRITERIO por MENOR PRECIO se asignará un puntaje de 50 puntos y al segundo 80 puntos y así sucesivamente de acuerdo al número de propuestas recibidas.
            </p>
        </div>
        ...
        <div class="text-block">
            En caso de empate en el puntaje total de dos o más cotizaciones la INSTITUCIÓN EDUCATIVA escogerá el oferente que tenga el mayor puntaje en el primero de los factores de escogencia y calificación establecidos del Proceso de Contratación es decir el factor económico. Si persiste el empate, escogerá a cotización que tenga el mayor puntaje en el segundo de los factores de escogencia y calificación establecidos en los pliegos del Proceso de Contratación técnico y así sucesivamente hasta agotar la totalidad de los factores de escogencia y calificación establecidos en los pliegos de condiciones. De persistir el empate se dará aplicación a las reglas señaladas en el artículo 2.2.1.1.2.2.9 del Decreto 1082 de 2015.
        </div>
        ...
        <div style="padding: 12px;">
            <div class="sig-line">
                ...
                @if($school->rector_document)
                    <div class="sig-detail">Cédula de ciudadanía número {{ $school->rector_document }}</div>
                @endif
