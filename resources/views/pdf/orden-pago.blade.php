...
<head>
    <meta charset="UTF-8">
    <title>Orden de Pago No. {{ $po->formatted_number }}</title>
    <style>
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        .header-table td { vertical-align: middle; padding: 12px 15px; }
...
<div class="container">
    <div class="doc-border">
        ...
        <table class="header-table">
            <tr>
                ...
                <td class="header-center">
                    ...
                    <div class="doc-title">ORDEN DE PAGO No. {{ $po->formatted_number }}</div>
        ...
        <div class="text-block">
            El RECTOR(A), en uso de sus atribuciones legales y en especial las que confiere la ley 115 de 1994, la ley 80 de 1993, Ley 715/2001 y el decreto 1075 de 2015:
        </div>
        ...
        <div class="resuelve-box">
            ...
            <table class="info-table" style="margin-top: 6px;">
                <tr>
                    <td class="info-label" style="width: 80px;">Código:</td>
                    <td>{{ $budgetItemCode }}</td>
                </tr>
                <tr>
                    <td class="info-label" style="width: 80px;">Rubro:</td>
        ...
        <table class="info-table" style="margin-top: 6px;">
            ...
            <tr>
                ...
                <td>
                    ...
                    <br>
                    <span style="text-transform: uppercase; color: #1e3a5f; font-weight: bold;">{{ $amountInWords }}</span>
                </td>
            </tr>
        </table>
